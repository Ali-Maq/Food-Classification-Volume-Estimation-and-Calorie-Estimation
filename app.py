...
with gr.Blocks() as demo:
    ...
    with gr.Tab("Volume Estimation"):
        ...
        gr.Markdown("-----------------------------------------------------------------------------")
        gr.Markdown("Please run the command below from where the Photogrammetry file is saved.")
        gr.Markdown("```bash \n $ ./HelloPhotogrammetry ./Burger_Data_3 ./Burger_Data3/Burger.usdz --detail medium  \n ```")
        gr.Markdown("(1) `./Burger_Data_3`: Input argument. A directory to the target image set.")
        gr.Markdown("(2) `./Burger_Data3/Burger.usdz`: Output file in either usdz or obj.")
        gr.Markdown("(3) `--detail medium`: File Quality that you want your 3D model to be.")
        gr.Markdown("-----------------------------------------------------------------------------")
